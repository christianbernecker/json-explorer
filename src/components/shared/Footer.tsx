    ...
    <footer className={`mt-auto py-4 border-t ${
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        <div className="text-sm mb-2 md:mb-0">
          &copy; {new Date().getFullYear()} JSON Tools <span className="mx-1">|</span> <span className="font-semibold">{APP_VERSION}</span> <span className="mx-1">|</span> by <a href="mailto:info@adtech-toolbox.com" className={`hover:underline ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>Christian Bernecker</a>
