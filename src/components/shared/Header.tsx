...
/**
 * Einheitliche Header-Komponente für die gesamte Anwendung
 * Vereint die Funktionalität aus AppHeader, ApplicationHeader und GlobalHeader
 */
const Header: React.FC<HeaderProps> = ({ 
  ...
  // Dynamische App-Icons und Titel basierend auf aktuellem Pfad
  const getAppIcon = () => {
    if (isTCFDecoder) {
      return (
  ...
  // App-Titel basierend auf Route oder explizitem Titel
  const getAppTitle = () => {
  ...
  // App-Untertitel basierend auf Route oder explizitem Untertitel
  ...
  return (
    <>
      ...
      {/* Abstandshalter für fixed header */}
